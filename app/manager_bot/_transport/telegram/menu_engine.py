...
class MenuEngine:
    ...
    def _setup_navigation_callbacks(self) -> None:
        ...
        self.callback_router.register_exact("filtro_seguridad:show", handle_menu_show, "Filtro Seguridad menu")
        self.callback_router.register_exact("filtro_contenido:show", handle_menu_show, "Filtro Contenido menu")
