...
class FiltersFeature(FeatureModule):
    ...
    def register_callbacks(self, router: "CallbackRouter") -> None:
        ...
        async def handle_show_menu(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.filters_menu import create_filters_menu
        ...
        async def handle_show_words(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.filters_menu import create_blocked_words_menu
        ...
        async def handle_show_sticker(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.filters_menu import create_sticker_blacklist_menu
        ...
        async def handle_show_list(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.filters_menu import create_filters_list_menu
        ...
        router.register_prefix("filters:words:del:", handle_del_word)
        router.register_prefix("filters:words:add", handle_add_word)
        router.register_exact("filters:sticker:show", handle_show_sticker)
        router.register_prefix("filters:sticker:add", handle_add_filter)
