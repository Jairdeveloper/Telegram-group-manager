...
class CaptchaFeature(FeatureModule):
    ...
    def register_callbacks(self, router: "CallbackRouter") -> None:
        ...
        async def handle_show_menu(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.captcha_menu import create_captcha_menu
        ...
        router.register_prefix("captcha:toggle", handle_toggle)
        router.register_prefix("captcha:type:", handle_type)
        router.register_prefix("captcha:timeout:", handle_timeout)
