...
class WarningsFeature(FeatureModule):
    ...
    def register_callbacks(self, router: "CallbackRouter") -> None:
        ...
        async def handle_show_menu(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.warnings_menu import create_warnings_menu
        ...
        router.register_prefix("warnings:autoban:", handle_toggle)
        router.register_prefix("warnings:max:", handle_max)
