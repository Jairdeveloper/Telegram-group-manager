...
class MediaFeature(FeatureModule):
    ...
    def register_callbacks(self, router: "CallbackRouter") -> None:
        ...
        async def handle_show_menu(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.media_menu import create_media_menu
        ...
        router.register_prefix("mod:media:photo:toggle", handle_toggle)
        router.register_prefix("mod:media:video:toggle", handle_toggle)
        router.register_prefix("mod:media:document:toggle", handle_toggle)
        router.register_prefix("mod:media:sticker:toggle", handle_toggle)
