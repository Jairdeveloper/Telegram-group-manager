...
class ReportsFeature(FeatureModule):
    ...
    def register_callbacks(self, router: "CallbackRouter") -> None:
        ...
        async def handle_show_menu(callback: "CallbackQuery", bot: "Bot", data: str):
            from app.manager_bot.menus.reports_menu import create_reports_menu
        ...
        router.register_prefix("reports:list:", handle_show_list)
        router.register_prefix("reports:resolve:", handle_resolve)
