"""SpamWatch integration (optional)."""
...
class SpamWatchClient:
    ...
    def check_user(self, user_id: int) -> Optional[SpamCheckResult]:
        ...
        if response.status_code in (204, 404):
            return SpamCheckResult(source="spamwatch", banned=False, reason="")
        ...
        return SpamCheckResult(source="spamwatch", banned=banned, reason=reason)
